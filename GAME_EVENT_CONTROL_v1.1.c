...
int main(void){
	...
	do{	
		...
		printf("\n\n\n\n\t\t\t\t\t\t       %c O QUE VOCE E?", 254);
		printf("\n\t\t\t\t\t\tÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
		gotoxy(49,15);printf("º    %c PARTICIPANTE         º", 254);
		printf("\n\t\t\t\t\t\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
		gotoxy(49,17);printf("º    %c EMPRESA              º", 254);
		printf("\n\t\t\t\t\t\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
		gotoxy(49,19);printf("º    %c PATROCINADOR         º", 254);
		printf("\n\t\t\t\t\t\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
		gotoxy(49,21);printf("º    %c SOBRE O EVENTO       º", 254);
		printf("\n\t\t\t\t\t\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
		gotoxy(49,23);printf("º    %c SAIR DO PROGRAMA     º", 254);
...
gamers acessar_dados_participante(){
	...
	do{
		...
		flag = 0;
		rewind(arq);
		gotoxy(52,10);printf("ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
		gotoxy(52,11);printf("º USUARIO:                º");
		gotoxy(52,12);printf("ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼\n\t");
		gotoxy(63,11);
		fflush(stdin);
		gets(user);
...
void mostra_patrocinador(patrocinadores empresa){
	...
	printf("\n\tÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
	printf("\n\tº   %c NOME %c                   º", 254, 175);
	printf("\n\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
	printf("\n\tº   %c EMAIL %c                  º", 254, 175);
	printf("\n\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
	printf("\n\tº   %c STAND %c                  º", 254, 175);
	printf("\n\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
	printf("\n\tº   %c PATROCINIO %c             º", 254, 175);
...
void mostra_patrocinio(){
	...
	system("cls");
	printf("\n\t\t\t\t\t\t\tPATROCINIOS\n");
	printf("ÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ");
...
void excluir_cadastro_participante(){
	...
	do{
		...
		printf("\nÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ");
		printf("\n\t\t\t\t\t    ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
		printf("\n\t\t\t\t\t    º   %c EXCLUIR PARTICIPANTE     º", 254);
		printf("\n\t\t\t\t\t    ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
		printf("\n\t\t\t\t\t    º   %c ORGANIZAR CADASTROS      º", 254);
		printf("\n\t\t\t\t\t    ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼");
		gotoxy(75, pos);printf(R"%c"B, 174);
		tecla = getch();
		if(tecla == DOWN)
...
void estatisticas(){
	...
	do{
		do{
			system("cls");
			gotoxy(45,9);printf("ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
			gotoxy(45,10);printf("º    %c TOTAL DE PARTICIPANTES           º", 254);
			gotoxy(45,11);printf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
			gotoxy(45,12);printf("º    %c PORCENTAGEM DE CADA STAND        º", 254);
			gotoxy(45,13);printf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
			gotoxy(45,14);printf("º    %c MAIOR ADESAO                     º", 254);
			gotoxy(45,15);printf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
			gotoxy(45,16);printf("º    %c STAND COM MAIOR PATROCINIO       º", 254);
			gotoxy(45,17);printf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
			gotoxy(45,18);printf("º    %c VOLTAR AO MENU DO ORGANIZADOR    º", 254);
			gotoxy(45,19);printf("ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼");
		...
		switch(pos){
			case 10:
				system("cls");
				printf("\n\tÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
				printf("\n\tº   TOTAL DE PARTICIPANTES DO EVENTO %c  %d   º", 175, total);
				printf("\n\tÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼\n\t");
				system("pause");
				break;
			case 12:
				system("cls");
				printf("\n\tÉÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
				printf("\n\tºGENERO   º PORCENTAGEM   º");
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºRPG      º %8.2f      º", p1 = (totalR*100)/max);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºFPS      º %8.2f      º", p2 = (totalF*100)/max);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºESPORTES º %8.2f      º", p3 = (totalE*100)/max);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºAVENTURA º %8.2f      º", p4 = (totalA*100)/max);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºCORRIDA  º %8.2f      º", p5 = (totalC*100)/max);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tºLUTA     º %8.2f      º", p6 = (totalL*100)/max);
				printf("\n\tÈÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼\n\t");
				system("pause");
				break;
			case 14:
				system("cls");
				printf("\n\tÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 187);
				printf("\n\tº %c MAIS RENTAVEL %c               º", 254, 175);
				printf("\n\tÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ%c", 185);
				printf("\n\tº %c N. DE PARTICIPANTES %c         º", 254, 175);
